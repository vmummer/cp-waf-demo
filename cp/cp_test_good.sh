...
for (( i=0; i<$repeat; ++i)); do
	...
	docker run -it --rm -v $(pwd)/data:/home/web-scraper/data --add-host juiceshop.local:$DOCKER_HOST cp-waf-demo-test-host python /home/web-scraper/websitescrap.py $host
