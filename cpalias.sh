...
alias cpnanos='echo "Check Point WAF Nano Agent Status" ; docker exec -it cp-waf /usr/sbin/cpnano -s |grep -E "^Version:|^Registration status|Reason:.{0,21}|CloudGuard|Policy version:|Token is invalid" '
