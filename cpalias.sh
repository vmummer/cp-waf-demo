...
alias cpnanos='echo "Check Point WAF Nano Agent Status" ; docker exec -it cp-waf /usr/sbin/cpnano -s |grep -E "^Version:|^Registration status|CloudGuard|Policy version:|Token is invalid" '
